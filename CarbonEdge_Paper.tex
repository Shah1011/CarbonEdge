...
Historical carbon intensity data is collected from the ElectricityMap API \cite{b9} using the past-range endpoint. The data collection pipeline has the following characteristics:
